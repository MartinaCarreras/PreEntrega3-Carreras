...
//Declaro funciones
function ingresoDineroJson() {
    localStorage.removeItem("dineroJSON");
    localStorage.setItem("dineroJSON", dineroActualNum);
}
...
formIngreso.addEventListener ("submit", (event) => {
    ...
    if (montoTemporal1 < 0) {
        ...
        dineroActualNum = dineroActualNum + parseFloat(montoIngreso.value);
        variableTemporal1 = new dinero (dineroActualNum);
...
formRetiro.addEventListener ("submit", (event) => {
    ...
    if (montoTemporal2 < 0) {
    ...
    }else if (montoTemporal2 > dineroActualNum){
        if (alertaRetiroActiva == false) {
            alertaRetiro.classList.remove ("none");
            alertaRetiroActiva = true;
        }
        ...
        dineroActualNum = dineroActualNum - parseFloat(montoRetiro.value);
        variableTemporal1 = new dinero (dineroActualNum);
        switch (dineroActualTipo.innerText) {
            case "$":
            dineroActualTexto.innerText = `${variableTemporal1.peso.toFixed(2)}`;
...
formCBU.addEventListener ("submit", (event) => {
    ...
    if (montoTemporal3 == 0) {
        ...
        dineroActualNum = dineroActualNum - montoTemporal3;
        variableTemporal1 = new dinero (dineroActualNum);
        switch (dineroActualTipo.innerText) {
            case "$":
                dineroActualTexto.innerText = `${variableTemporal1.peso.toFixed(2)}`;
...
formAlias.addEventListener ("submit", (event) => {
    ...
    if (montoTemporal4 == 0) {
        ...
        dineroActualNum = dineroActualNum - montoTemporal4;
        variableTemporal1 = new dinero (dineroActualNum);
        switch (dineroActualTipo.innerText) {
            case "$":
                dineroActualTexto.innerText = `${variableTemporal1.peso.toFixed(2)}`;
